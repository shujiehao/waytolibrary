...
public class MapLayer19Dao extends AbstractDao<MapLayer19, Void> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MapLayer19 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MapLayer19 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Void updateKeyAfterInsert(MapLayer19 entity, long rowId) {
    ...
    @Override
    public boolean hasKey(MapLayer19 entity) {
        // TODO
        return false;
    }
