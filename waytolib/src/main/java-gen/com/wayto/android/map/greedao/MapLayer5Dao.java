...
public class MapLayer5Dao extends AbstractDao<MapLayer5, Void> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MapLayer5 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MapLayer5 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Void updateKeyAfterInsert(MapLayer5 entity, long rowId) {
    ...
    @Override
    public boolean hasKey(MapLayer5 entity) {
        // TODO
        return false;
    }
