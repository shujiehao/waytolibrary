...
public class MapLayer14Dao extends AbstractDao<MapLayer14, Void> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MapLayer14 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MapLayer14 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Void updateKeyAfterInsert(MapLayer14 entity, long rowId) {
    ...
    @Override
    public boolean hasKey(MapLayer14 entity) {
        // TODO
        return false;
    }
