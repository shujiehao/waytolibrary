...
public class MapLayer15Dao extends AbstractDao<MapLayer15, Void> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MapLayer15 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MapLayer15 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Void updateKeyAfterInsert(MapLayer15 entity, long rowId) {
    ...
    @Override
    public boolean hasKey(MapLayer15 entity) {
        // TODO
        return false;
    }
