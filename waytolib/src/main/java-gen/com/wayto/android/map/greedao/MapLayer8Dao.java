...
public class MapLayer8Dao extends AbstractDao<MapLayer8, Void> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MapLayer8 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MapLayer8 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Void updateKeyAfterInsert(MapLayer8 entity, long rowId) {
    ...
    @Override
    public boolean hasKey(MapLayer8 entity) {
        // TODO
        return false;
    }
