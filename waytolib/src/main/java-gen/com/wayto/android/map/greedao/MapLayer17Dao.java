...
public class MapLayer17Dao extends AbstractDao<MapLayer17, Void> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MapLayer17 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MapLayer17 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Void updateKeyAfterInsert(MapLayer17 entity, long rowId) {
    ...
    @Override
    public boolean hasKey(MapLayer17 entity) {
        // TODO
        return false;
    }
