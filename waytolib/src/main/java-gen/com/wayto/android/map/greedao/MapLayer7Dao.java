...
public class MapLayer7Dao extends AbstractDao<MapLayer7, Void> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MapLayer7 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MapLayer7 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Void updateKeyAfterInsert(MapLayer7 entity, long rowId) {
    ...
    @Override
    public boolean hasKey(MapLayer7 entity) {
        // TODO
        return false;
    }
