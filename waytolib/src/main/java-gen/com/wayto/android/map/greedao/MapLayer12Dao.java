...
public class MapLayer12Dao extends AbstractDao<MapLayer12, Void> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MapLayer12 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MapLayer12 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Void updateKeyAfterInsert(MapLayer12 entity, long rowId) {
    ...
    @Override
    public boolean hasKey(MapLayer12 entity) {
        // TODO
        return false;
    }
