...
public class MapLayer10Dao extends AbstractDao<MapLayer10, Void> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MapLayer10 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MapLayer10 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Void updateKeyAfterInsert(MapLayer10 entity, long rowId) {
    ...
    @Override
    public boolean hasKey(MapLayer10 entity) {
        // TODO
        return false;
    }
