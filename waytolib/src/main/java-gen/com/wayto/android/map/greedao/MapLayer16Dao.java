...
public class MapLayer16Dao extends AbstractDao<MapLayer16, Void> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MapLayer16 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MapLayer16 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Void updateKeyAfterInsert(MapLayer16 entity, long rowId) {
    ...
    @Override
    public boolean hasKey(MapLayer16 entity) {
        // TODO
        return false;
    }
