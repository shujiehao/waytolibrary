...
public class MapLayer3Dao extends AbstractDao<MapLayer3, Void> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MapLayer3 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MapLayer3 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Void updateKeyAfterInsert(MapLayer3 entity, long rowId) {
    ...
    @Override
    public boolean hasKey(MapLayer3 entity) {
        // TODO
        return false;
    }
