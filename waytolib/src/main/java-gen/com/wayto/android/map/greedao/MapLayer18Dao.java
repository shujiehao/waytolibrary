...
public class MapLayer18Dao extends AbstractDao<MapLayer18, Void> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MapLayer18 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MapLayer18 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Void updateKeyAfterInsert(MapLayer18 entity, long rowId) {
    ...
    @Override
    public boolean hasKey(MapLayer18 entity) {
        // TODO
        return false;
    }
