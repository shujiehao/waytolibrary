...
public class MapLayer13Dao extends AbstractDao<MapLayer13, Void> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MapLayer13 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MapLayer13 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Void updateKeyAfterInsert(MapLayer13 entity, long rowId) {
    ...
    @Override
    public boolean hasKey(MapLayer13 entity) {
        // TODO
        return false;
    }
