...
public class MapLayer11Dao extends AbstractDao<MapLayer11, Void> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MapLayer11 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MapLayer11 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Void updateKeyAfterInsert(MapLayer11 entity, long rowId) {
    ...
    @Override
    public boolean hasKey(MapLayer11 entity) {
        // TODO
        return false;
    }
