...
public class MapLayer2Dao extends AbstractDao<MapLayer2, Void> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MapLayer2 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MapLayer2 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Void updateKeyAfterInsert(MapLayer2 entity, long rowId) {
    ...
    @Override
    public boolean hasKey(MapLayer2 entity) {
        // TODO
        return false;
    }
