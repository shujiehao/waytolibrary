...
public class MapLayer9Dao extends AbstractDao<MapLayer9, Void> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MapLayer9 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MapLayer9 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Void updateKeyAfterInsert(MapLayer9 entity, long rowId) {
    ...
    @Override
    public boolean hasKey(MapLayer9 entity) {
        // TODO
        return false;
    }
